...
VOLUME_INCREASE_BY_GB=${VOLUME_INCREASE_BY_GB:-10240} # 1TB in GB
VOLUME_FREE_PERCENT=${VOLUME_FREE_PERCENT:-20} # 20% free
VOLUME_FREE_GB=${VOLUME_FREE_GB:-200} # 200GB free
